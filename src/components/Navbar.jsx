...
const Navbar = () => {
  ...
  return (
    <nav className="navbar-flancraft">
      <div className="navbar-content">
        ...
        <div className="nav-left-wrapper">
          ...
          <div className={`nav-center links ${menuOpen ? 'open' : ''}`}>
          ...
          {!isLoggedIn ? (
            ...
            <>
              ...
              >
                ...
                <div
                  className={`user-dropdown-wrapper ${profileOpen ? 'open' : ''}`}
                  onMouseEnter={handleProfileEnter}
                  onMouseLeave={handleProfileLeave}
                >
                  <div className="user-dropdown">
                    <div className="user-header">
                      ...
                      <div>
                        <p className="username-big">
                          {username} <span className="level-text">Nv. {userLevel}</span>
                        </p>
                    ...
                    <div className="xp-bar-profile">
                      <div
                        className="xp-fill"
                        style={{ width: `${(userXP / userXPMax) * 100}%` }}
                      />
                    </div>
